...
export default {
    ...
    data() {
        return {
            ...
            categories: [],
            // APIs
            ticketRolesDetails: 'https://ticketoapi.liara.run/api/tickets/roles/details/', // tid
            userDetailsAPI: 'https://ticketoapi.liara.run/api/users/details/', // uid
            ticketRolesMainDetailsAPI: 'https://ticketoapi.liara.run/api/ticketsroles/details/', // pk
            ticketsAddAPI: 'https://ticketoapi.liara.run/api/tickets/add/', // tid, uid
            ...
            ticketMessagesAPI: 'https://ticketoapi.liara.run/api/tickets/messages/details/', // tid
            deleteMessageAPI: 'https://ticketoapi.liara.run/api/messages/details/', // mid
                ...
                <div class="card-body min-h-full ">
                    <div class="avatar mb-5">
                        <div class="w-24 rounded-full">
                            ...
                            <img :src="`https://ticketoapi.liara.run${userPfp}`" v-else />
                        </div>
                                                                ...
                                                                <div class="flex items-center space-x-3">
                                                                    <div class="avatar">
                                                                        <div class="mask mask-squircle w-12 h-12">
                                                                            <img :src="`https://ticketoapi.liara.run${user.pfp}`"
