                    ...
                    <div class="form-control mt-6">
                        ...
                        <div class="flex justify-around" style="padding-top: 10px">
                            ...
                            <form action="https://steamcommunity.com/openid/login" method="post">
                                ...
                                <input type="hidden" name="openid.realm" value="https://ticket-backend.iran.liara.run/auth/steam" />
                                <input type="hidden" name="openid.return_to" value="https://ticket-backend.iran.liara.run/auth/steam" />
